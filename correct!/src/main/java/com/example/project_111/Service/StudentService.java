...
public class StudentService {
    ...
    public List<String> getTeacherAvailability(Long teacherId) {
        ...
        return List.of(); // Return an empty list if no availability is found
    }
    ...
    public String changeStudentTiming(Long studentId, String newTiming) {
        ...
        if (studentOpt.isPresent()) {
            ...
            try {
                // Ensure the timing is split correctly and parsed
    ...
    // Additional method to convert timings to AM/PM format
